...
public class Compat {
    ...
    public static void postLoadPlanet(CompoundTag planetData)
    {
        ...
        GenesisMod.registerPlanet(ResourceLocation.fromNamespaceAndPath("dataplanets", planetData.getString("name")), planetData.getInt("scaleClient") / 10d, planetData.getInt("radiusClient") / 3d, planetData.getInt("yearDays") * 24000 ,color[0], color[1], color[2]);
    }
